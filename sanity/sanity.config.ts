...
const projectId =
  process.env.NEXT_PUBLIC_SANITY_PROJECT_ID || process.env.SANITY_STUDIO_PROJECT_ID || 'd205mlci'
const dataset =
...
// (The Sanity starter also resolved `post` documents to /posts/:slug; that
// document type has been removed.)
