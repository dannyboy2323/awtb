The diff only changes image dimensions and responsive `sizes` attributes in the `DeskHero` component — none of this affects the architecture documentation. The doc is already accurate.
