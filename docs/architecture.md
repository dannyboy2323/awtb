...
The static About route presents Danny's first-person origin story using the
installed dark shadcn tokens and marks its navigation link with the muted
foreground token and `aria-current="page"`.
