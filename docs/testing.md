...
| `tests/unit/StoryDrawer.test.tsx`      | Drawer order, visibility, read state, and story selection   |
...
from regressing. The about page, floating-navigation, story-drawer, sharing, and EPUB files
have dedicated 100% statement, branch, function, and line thresholds. The report
is generated by `npm run test:coverage`.
...
| File                        | What it tests                                                        |
| --------------------------- | -------------------------------------------------------------------- |
| `tests/e2e/landing.spec.ts` | Home/About nav, postcard drawer, story nav, sharing, favorites, EPUB |
